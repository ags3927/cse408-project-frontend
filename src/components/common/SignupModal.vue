                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                <b-form-checkbox
                                    ...
                                    <h6 style="line-height: 25px; font-size: 14px">I agree with the Terms &
                                        Conditions.</h6>
                                </b-form-checkbox>
                        ...
                        <div class="form-group">
                            ...
                            <button @click.prevent="triggerLogin" id="signup-login" class="btn h6 text-primary"
                                    style="line-height: 25px; font-size: 14px">Log in
                            </button>
                        </div>
